...
function [pis] = pi_nk(n_mat,K,data)
...
function [pis] = pi_nk_conj(F_multi,K,data)
...
revlex2conj = data.revlex2conj;   % Set to convert indices from rev. lex. to conjugate ordering
